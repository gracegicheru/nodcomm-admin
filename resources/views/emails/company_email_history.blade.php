      ...
      <div class="row filter-wrapper" style="display:none;">
        <div class="col-md-12">
          <div class="box box-widget">
            ...
            <div class="box-body">
			 <form role="form" method="post" action="<?php echo URL::route('apply_company_email_filters') ?>" id="ApplyCompanyfilterform">
             {{ csrf_field() }}
              <div class="row" style="margin-right: -10px;margin-left: -10px;">
                <div class="col-md-4">
				@if (Auth::user()->admin && Auth::user()->company_id==0)
				<input type="hidden" class="form-control pull-right" name="companyid" value="<?php 	
					  echo $companyid;?>"/>
				@endif
                  <label>From</label>
					<div class="input-group date">
					  ...
					  <input type="text" class="form-control pull-right" id="datepicker" value="<?php 	
					  echo $date;?>"/>
					</div>
                </div>
                <div class="col-md-4">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepicker1" value="<?php 	
				  echo $date;?>">
                </div>
