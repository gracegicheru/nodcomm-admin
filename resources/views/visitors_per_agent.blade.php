...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
	  {{ ucwords($visitors->name)}} Visitors
      </h1>
      <ol class="breadcrumb">
        <li><a href="/"><i class="fa fa-dashboard"></i> Home</a></li>

        <li class="active">{{ ucwords($visitors->name)}} Visitors</li>
      </ol>
    </section>
			...
			<div class="box-body visitors-tbl">
              <div class="box-body table-responsive no-padding" style="font-weight: normal;">
                <table class="table table-hover">
                  ...
                  @else
                      <tr>
                        <td class="text-center" colspan="7"><div style="padding:20px;">{{ ucwords($visitors->name)}} has no visitors</div></td>
                      </tr>
                  @endif
                  </tbody>
                </table>
