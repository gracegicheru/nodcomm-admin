            ...
            <div class="section">
              ...
              <div class="row">
			     <div class="col s12">
                    ...
                    <div class="row">
					<form role="form" method="post" action="<?php echo URL::route('superadduser') ?>" id="superregisterform">
					{{ csrf_field() }}
						...
						<div class="row">
                          <div class="row">
                            <div class="input-field col s12">
                              <button id="superregisterbtn" class="btn cyan waves-effect waves-light right" type="submit">
                  ...
                  <div class="card-panel hide" id="editagentdiv">
                    ...
                    <div class="row">
					 <form role="form" method="post" action="<?php echo URL::route('superedituser') ?>" id="supereditform">
                       {{ csrf_field() }}
					   <div class="row">
                          <div class="input-field col s12">
                            <i class="material-icons prefix">account_circle</i>
                        ...
                        <div class="input-field col s12">
						<i class="material-icons prefix">language</i>
                          <select name="company" id="company1">
                            <option value="" disabled selected>Please select a company</option>
						   <?php
						   if(!empty($companies))
					       {
						...
						<div class="row">
                          <div class="row">
							...
							<input type="hidden" class="form-control" name="id" id="id">
                              <button  class="btn cyan waves-effect waves-light right" type="submit" id="superedittbtn">Edit
						  ...
						  <tbody>
								@if (count($users) > 0)
									...
									@foreach($users as $user)
										...
										<td>
										<a class="btn tooltipped" data-position="top" data-delay="50" data-tooltip="Edit" onclick="superedit({{ $user->id }})" id="supereditbtn{{ $user->id }}" style="margin-right:3px;"><i class="fa fa-pencil" aria-hidden="true"></i></a>
										<?php if($user->active == 1) { ?>
										<a class="btn tooltipped" data-position="top" data-delay="50" data-tooltip="Disable" onclick="superdisableagent({{ $user->id }})" id="superdisableagentbtn{{ $user->id }}" style="margin-right:3px;"><i class="fa fa-times" aria-hidden="true"></i></a>
										<?php }else{ ?>
										<a class="btn tooltipped" data-position="top" data-delay="50" data-tooltip="Enable" onclick="superenableagent({{ $user->id }})"  id="superenableagentbtn{{ $user->id }}" style="margin-right:3px;"><i class="fa fa-check" aria-hidden="true"></i></a>
										<?php } ?>
										<?php 
											//$url = '/login/'.$user->id;
