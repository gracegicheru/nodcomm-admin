						...
						<div class="chat-holder">
							<div class="row chat-window " id="chat_window_1">
								<div class="col s12 ">
											...
											<div class="top-bar">
												<div class="col s6">
													<h6 class="panel-title"><i class="fa fa-comment-o" aria-hidden="true"></i> {{$company}} Enquiry</h6>
												</div>
											...
											<div class="row msg_container_base"  id="chatdiv">
												...
												@if($message->company_id==0 || $message->user_id==$support_message->user_id)
												@if($message->company_id==0)
													<div class="row msg_container base_sent">
														<div class="col s10">
															<div class="messages msg_sent">
															<p style="color:blue;">Support #{{$message->user->name}}</p>
												  ...
												  <div class="row msg_container base_receive">
													...
													<div class="col s10">
														<div class="messages msg_receive">
															<p style="color:blue;">Client #{{$message->user->name}}</p>
															<p>{{$message->description}}</p>
															<p class="time_date"><span>Sent: </span>
															{{date("D M j Y G:i:s",strtotime($message->created_at))}}
															</p>
...
<script src="{{ url('assets/js/support_message.js') }}"></script>
