                                ...
                                <div id="striped-table">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s12">
                                            ...
                                            <div id="table-datatables" style="padding-top: 10px;">
                                                <div class="row">
                                                    ...
                                                    <div class="col s12">
                                                        <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                <td style="width:15%;">{{$message->created_at}}</td>
                                                                ...
                                                                <td style="width:10%; text-align:center; ">{{$message->status}}</td>
                                                                <td><a style="text-decoration: underline; width:10%; text-align: center;" href="/showDetails/{{$message->id}}">details</a></td>
