		...
		$.ajax({
			...
			success:  function(data){
				...
				if(data.status == "success"){
					...
					$("#message").val('');
					var div='<div class="row msg_container base_receive"><div class="col s2 avatar"><i class="fa fa-user" aria-hidden="true"></i></div><div class="col s10"><div class="messages msg_receive"><p style="color:blue;">Me</p><p>'+data.details.description+'</p>';
					div+='<p class="time_date"><span>Sent: </span>'+data.details.time+'</p></div></div></div>';
					$("#chatdiv").append(div);	
					$.gritter.add({
